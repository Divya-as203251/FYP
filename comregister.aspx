...
<head runat="server">
    ...
    <style type="text/css">
        ...
        body{
            background-image:url('job_interview_illustration_4x.jpg');
            margin-left:10%;
        }
    </style>
</head>
            ...
            <table align="center" class="auto-style2" >
                 <tr>
                    <td class="auto-style4">
                        <asp:Label ID="Label7" runat="server" Text="Company ID"></asp:Label>
                    </td>
                    <td>
                ...
                <br/>
                <br/>
                Already registered?&nbsp; <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/companylogin.aspx">Login</asp:HyperLink>
            </div>
    </form>
</body>
</html>
